...
{
    protected $hidden = ['delete_time', 'create_time', 'activity_img_id'];


    public function thumb()
    {
        return $this->belongsTo('Media', 'activity_img_id', 'id');
    }

    public function prize()
    {
        return $this->belongsToMany('Prize', 'ActivityPrize', 'prize_id', 'activity_id');
    }

    public function user()
    {
        return $this->belongsToMany('User','ActivityUser', 'user_id', 'activity_id');
    }

    public function winner()
    {
        return $this->hasMany('Winner', 'activity_id', 'id');
    }

    public function more()
    {
        return $this->hasMany('PrizeMore', 'activity_id', 'id');
    }
    ...
    {
        return ActivityPrizeModel::getVarCount(['activity_id' => $id]);
    }
    ...
    public static function updateActivity($data)
    {
        ...
        try{
            ...
            ActivityPrizeModel::where(['activity_id' => $act->id])->update([
                'prize_id' => intval($data['prize_id']),
            ]);
        }catch(\Exception $e){
            Db::rollback();
    ...
    public function deleteOne($id)
    {
        ...
        try{
            self::destroy($id);
            if (!ActivityPrizeModel::destroy(['activity_id' => $id])){
