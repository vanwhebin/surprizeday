  ...
  <div class="container">
    <div class="quantity-statistics">
      <div class="quantity-item">
        <div class="quantity-detail">
          <div class="quantity-detail-box">
            <div class="quantity-title">总参与人数</div>
            <div class="quantity-border-line"></div>
            <div class="quantity">{{ participants.total }}</div>
          </div>
        </div>
      ...
      <div class="quantity-item">
        <div class="quantity-detail">
          <div class="quantity-detail-box">
            <div class="quantity-title">新增参与人数 (天)</div>
            <div class="quantity-border-line"></div>
            <div class="quantity">{{ participants.new }}</div>
          </div>
        </div>
        <div class="quantity-icon">
          <img src="../../assets/img/about/icon.png" alt="">
      ...
      <div class="quantity-item">
        <div class="quantity-detail">
          <div class="quantity-detail-box">
            ...
            <div class="quantity-border-line"></div>
            <div class="quantity">{{ users.total }}</div>
          </div>
        </div>
        <div class="quantity-icon">
          <img src="../../assets/img/about/icon.png" alt="">
      ...
      <div class="quantity-item">
        <div class="quantity-detail">
          <div class="quantity-detail-box">
            ...
            <div class="quantity-border-line"></div>
            <div class="quantity">{{ users.new }}</div>
          </div>
        </div>
        <div class="quantity-icon">
          <img src="../../assets/img/about/icon.png" alt="">
